    ...
    <div className="space-y-6 min-w-0">
      <article className="panel animate-fade-in rounded-[32px] p-5 sm:p-8 lg:p-10">
        <div className="flex flex-col gap-6">
          <div className="min-w-0">
            <p className="text-xs font-bold uppercase tracking-[0.28em] text-[#006B8E]">WELCOME BACK</p>
            <h1 className="mt-3 text-[clamp(1.8rem,5vw,2.25rem)] font-extrabold tracking-tight text-slate-900">Welcome back, Raphael</h1>
      ...
      <article className="panel animate-slide-up rounded-[28px] p-5 sm:p-6">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
          ...
          <span className="w-fit rounded-full bg-[#eefbfe] px-3 py-1 text-xs font-semibold uppercase tracking-wide text-[#005B80]">Searchable</span>
        </div>
        <div className="mt-4">
