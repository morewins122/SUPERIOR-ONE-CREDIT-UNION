...
const featureCards = [
  ...
  },
  {
    ...
    icon: Building2,
    description: "Visit our Tampa, Florida branch for personalized service and financial guidance."
  },
  {
...
export function LandingPage() {
  ...
  const featuredBranches = [
    { city: "Tampa, Florida", label: "Downtown Tampa Branch", description: "Downtown Tampa branch serving the city’s financial district." },
    { city: "St. Petersburg, Florida", label: "St. Petersburg Main Branch", description: "A neighborhood branch for everyday banking and member guidance." },
    { city: "Orlando, Florida", label: "Central Orlando Branch", description: "Orlando branch for personal banking and support." },
    { city: "Miami, Florida", label: "Miami Lakes Branch", description: "Miami branch for members and business banking services." }
  ];
        ...
        <div className="relative overflow-hidden rounded-3xl bg-white p-6 shadow-card ring-1 ring-slate-200 sm:p-8">
          <div className="pointer-events-none absolute inset-0">
            <div
              ...
              aria-hidden="true"
            />
            <div className="absolute inset-0 bg-gradient-to-br from-white via-white/90 to-[#eaf8fb]/85" aria-hidden="true" />
            <div className="absolute -right-10 -top-10 h-48 w-48 rounded-full bg-[#0077A8]/10 blur-2xl" aria-hidden="true" />
            <div className="absolute -bottom-12 -left-10 h-56 w-56 rounded-full bg-[#00A2B7]/15 blur-2xl" aria-hidden="true" />
          </div>

          <div className="relative z-10 max-w-2xl space-y-4">
            <p className="inline-flex items-center rounded-full bg-[#eaf8fb] px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-[#0077A8]">
            ...
            <div className="flex flex-wrap gap-3">
              <Link to={homepageContent.hero.primaryCtaHref} className="rounded-full bg-[#0077A8] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#005A7A]">
      ...
      <section className="relative left-1/2 right-1/2 w-screen -translate-x-1/2 bg-white px-4 py-[60px] sm:px-6 lg:px-8 lg:py-[70px]">
        <div className="mx-auto flex w-full max-w-[1400px] flex-col items-center gap-10">
          <div className="max-w-3xl space-y-3 text-center animate-fade-in">
            <p className="text-xs font-bold uppercase tracking-[0.28em] text-[#005B80]">Why Bank With Tampa Bay Credit Union</p>
            <h2 className="text-[clamp(2rem,4vw,3rem)] font-extrabold tracking-tight text-slate-900">Why Bank With Tampa Bay Credit Union</h2>
            ...
            {featureCards.map((card, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <span className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-[#eaf8fb] text-[#005B80] transition-transform duration-300 group-hover:scale-105">
          ...
          <article className="w-full rounded-[20px] bg-[#F8FAFC] p-6 shadow-[0_10px_30px_rgba(0,0,0,.08)] sm:p-8">
            <div className="mx-auto max-w-4xl text-center">
              <p className="text-xs font-bold uppercase tracking-[0.24em] text-[#005B80]">Accessibility</p>
              <h3 className="mt-3 text-2xl font-bold tracking-tight text-slate-900">Tampa Bay Credit Union is committed to providing an accessible website for all members.</h3>
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-[1fr_auto_auto] lg:items-center lg:justify-items-center">
                <div className="inline-flex items-center justify-center gap-3 rounded-2xl border border-slate-200 bg-white px-5 py-4 text-slate-700">
                  <PhoneCall size={18} className="text-[#005B80]" />
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-[#005B80] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#0077A8]"
                >
                  <MapPin size={16} />
                  Branch Locator
                </button>
          ...
          <div className="w-full">
            <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
              <div className="text-center sm:text-left">
                <p className="text-xs font-bold uppercase tracking-[0.24em] text-[#005B80]">Trust &amp; Protection</p>
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
              {trustBadges.map((badge, index) => (
                ...
                >
                  <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#eefaff] text-[#005B80]">
            ...
            <div className="fixed inset-0 z-[120] flex items-center justify-center bg-slate-900/45 p-4 backdrop-blur-sm">
              <div className="w-full max-w-3xl rounded-[24px] bg-white p-6 shadow-[0_24px_70px_rgba(15,23,42,0.22)] sm:p-8">
                <div className="flex items-start justify-between gap-4 border-b border-slate-200 pb-4">
                  <div>
                    <p className="text-xs font-bold uppercase tracking-[0.22em] text-[#005B80]">Branch Locator</p>
                  ...
                  {featuredBranches.map((branch) => (
                    <article key={branch.city} className="rounded-[20px] border border-slate-200 bg-[#f8fbfc] p-5 transition hover:-translate-y-1 hover:shadow-[0_12px_30px_rgba(0,0,0,.08)]">
                      <div className="flex items-start gap-3">
                        <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#eaf8fb] text-[#005B80]">
                          <MapPin size={18} />
                        </span>
                        <div>
